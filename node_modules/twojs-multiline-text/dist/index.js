...
var Two__default = /*#__PURE__*/_interopDefaultLegacy(Two);
...
class MultilineText extends Two__default["default"].Group {
...
Object.assign(MultilineText.prototype, {
    _update(bubbles) {
        if (this._flagWrapping) {
            ...
            const lines = wrap__default["default"]
                .lines(this.value, {
                measure,
                width: this.width,
                mode: this.mode
            ...
            while (texts.length < lines.length) {
                this.add(new Two__default["default"].Text(lines[texts.length].trim(), 0, 0));
            }
            this._flagStyle = true;
        }
        if (this._flagStyle) {
        ...
        Two__default["default"].Group.prototype
